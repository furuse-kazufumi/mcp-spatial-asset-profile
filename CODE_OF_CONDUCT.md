...
We as members, contributors, and maintainers pledge to make participation in the **MCP Spatial Asset Profile v2** project a harassment-free experience for everyone, regardless of age, body size, visible or invisible disability, ethnicity, sex characteristics, gender identity and expression, level of experience, education, socio-economic status, nationality, personal appearance, race, religion, or sexual identity and orientation.
...
- Welcoming contributions and questions in any of the project's supported languages (English, Japanese, Simplified Chinese, and the brief summary languages under `docs/i18n/`).
...
This Code of Conduct applies within all project spaces — including the GitHub repository, issues, pull requests, Discussions, and any other communication channel used for project work — and also applies when an individual is officially representing the project in public spaces.

## Enforcement

Instances of abusive, harassing, or otherwise unacceptable behavior may be reported to the project maintainers by opening a private contact channel (for example, a GitHub Issue marked as security/sensitive, or by contacting the repository owner directly). All complaints will be reviewed and investigated promptly and fairly.
